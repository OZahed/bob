...
type Database interface {
	...
	// Embed the Querier interface for data fetching and manipulating methods.
	Querier
}

// Querier is a subset of the sql.DB interface but only for methods which works with actual data.
// It is used to wrap the sql.DB and sql.Tx types with extra functionality.
type Querier interface {
	...
	// Prepare and PrepareContext are not included in the Querier interface
	// because they return a Stmt interface which is not a Querier compatible with sqlx and sql interface
